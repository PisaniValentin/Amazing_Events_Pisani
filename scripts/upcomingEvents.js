...
let upcomingEventArray = eventos.events.filter(dato => dato.date > eventos.currentDate);


insertCards(upcomingEventArray);


let categoriasContainer = document.getElementById('categorias');
categoriasContainer.innerHTML = generateCategories(upcomingEventArray);
